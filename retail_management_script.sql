...
(1, 'Pune Central Store', '0201234567', 'Pune', 'FC Road, Shivajinagar, Pune, Maharashtra'),
(2, 'Mumbai Retail Hub', '0229876543', 'Mumbai', 'Linking Road, Bandra West, Mumbai, Maharashtra'),
(3, 'Delhi Super Mart', '0115566778', 'Delhi', 'Connaught Place, New Delhi, Delhi');
...
UPDATE Store SET city = 'Pune', address = 'FC Road, Shivajinagar, Pune, Maharashtra' WHERE store_id = 1;
UPDATE Store SET city = 'Mumbai', address = 'Linking Road, Bandra West, Mumbai, Maharashtra' WHERE store_id = 2;
UPDATE Store SET city = 'Delhi', address = 'Connaught Place, New Delhi, Delhi' WHERE store_id = 3;

INSERT INTO Store VALUES
(4, 'Nagpur Mega Store', '0712345678', 'Nagpur', 'Sitabuldi Main Road, Nagpur, Maharashtra'),
(5, 'Bangalore Tech Hub', '0801234567', 'Bangalore', 'MG Road, Bangalore, Karnataka'),
(6, 'Chennai Retail Center', '0441234567', 'Chennai', 'Anna Salai, Chennai, Tamil Nadu'),
(7, 'Hyderabad Super Mart', '0401234567', 'Hyderabad', 'Banjara Hills, Hyderabad, Telangana'),
(8, 'Kolkata Central Store', '0331234567', 'Kolkata', 'Park Street, Kolkata, West Bengal'),
(9, 'Ahmedabad Retail Hub', '0791234567', 'Ahmedabad', 'CG Road, Ahmedabad, Gujarat'),
(10, 'Jaipur Mega Mart', '0141234567', 'Jaipur', 'MI Road, Jaipur, Rajasthan');
